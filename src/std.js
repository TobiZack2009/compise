...
export const STD_NAMESPACES = {
  ...
  'std/collections': {
    Map: {
      ...
      clear: { params: [TYPES.Map], returnType: TYPES.void, stub: '__jswat_map_clear' },
    ...
    Set: {
      ...
      clear: { params: [TYPES.Set], returnType: TYPES.void, stub: '__jswat_set_clear' },
    ...
    Queue: {
      ...
      peek: { params: [TYPES.Queue], returnType: TYPES.isize, stub: '__jswat_queue_peek' },
      empty: { params: [TYPES.Queue], returnType: TYPES.bool, stub: '__jswat_queue_empty' },
    ...
    Stack: {
      ...
      peek: { params: [TYPES.Stack], returnType: TYPES.isize, stub: '__jswat_stack_peek' },
      empty: { params: [TYPES.Stack], returnType: TYPES.bool, stub: '__jswat_stack_empty' },
    ...
    Deque: {
      ...
      peekFront: { params: [TYPES.Deque], returnType: TYPES.isize, stub: '__jswat_deque_peek_front' },
      peekBack: { params: [TYPES.Deque], returnType: TYPES.isize, stub: '__jswat_deque_peek_back' },
      empty: { params: [TYPES.Deque], returnType: TYPES.bool, stub: '__jswat_deque_empty' },
...
export const STD_FUNCTIONS = {
  'std/iter': {
    iter: { params: [TYPES.array], returnType: TYPES.iter, stub: '__jswat_iter_from_array' },
  },
  'std/wasm': {
