 ...
 * @returns {string[]}
 */
function buildCollectionsFunctions() {
  const funcs = [];

  funcs.push(buildFunction({
    name: '__jswat_map_new',
    params: [],
    result: 'i32',
    locals: [local('ptr', 'i32')],
    body: [
      i32Const(12),
      'call $__alloc',
      'local.tee $ptr',
  ...
  funcs.push(buildFunction({
    name: '__jswat_map_set',
    params: [param('map', 'i32'), param('key', 'i32'), param('value', 'i32')],
    result: '',
    locals: [local('cur', 'i32')],
    body: [
      'local.get $map',
      'i32.eqz',
      'if',
  ...
  funcs.push(buildFunction({
    name: '__jswat_map_get',
    params: [param('map', 'i32'), param('key', 'i32')],
    result: 'i32',
    locals: [local('cur', 'i32')],
    body: [
      'local.get $map',
  ...
  funcs.push(buildFunction({
    name: '__jswat_map_delete',
    params: [param('map', 'i32'), param('key', 'i32')],
    result: 'i32',
    locals: [local('cur', 'i32'), local('prev', 'i32')],
    body: [
      'local.get $map',
      'i32.eqz',
      'if (result i32)',
  ...
  funcs.push(buildFunction({
    name: '__jswat_set_add',
    params: [param('set', 'i32'), param('value', 'i32')],
    result: '',
    locals: [local('cur', 'i32')],
    body: [
      'local.get $set',
  ...
  funcs.push(buildFunction({
    name: '__jswat_stack_push',
    params: [param('stack', 'i32'), param('value', 'i32')],
    result: '',
    locals: [local('node', 'i32')],
    body: [
      'local.get $stack',
      'i32.eqz',
      'if',
  ...
  funcs.push(buildFunction({
    name: '__jswat_queue_push',
    params: [param('queue', 'i32'), param('value', 'i32')],
    result: '',
    locals: [local('node', 'i32')],
    body: [
      'local.get $queue',
  ...
  funcs.push(buildFunction({
    name: '__jswat_deque_push_front',
    params: [param('deque', 'i32'), param('value', 'i32')],
    result: '',
    locals: [local('node', 'i32')],
    body: [
      'local.get $deque',
...
export function generateWat(ast, signatures, classes, imports, filename = '<input>') {
  ...
  const hasCollections = Array.from(stdStubs).some(name =>
    ...
    name.startsWith('__jswat_queue_') ||
    name.startsWith('__jswat_stack_') ||
    name.startsWith('__jswat_deque_')
  );
